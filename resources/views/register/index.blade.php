    ...
    @section('container')
        <div class="row justify-content-center" >
            <div class="col-lg-5">
                <main class="form-regrisration">
                    <h1 class="h3 mb-3 fw-normal text-center">Masukin Sekarang!</h1>
            ...
            <small class="d-block text-center mt-3">Sudah Masuk? <a href="/login">Masuk Sini </a></small>
            </main>
        </div>
    </div>
